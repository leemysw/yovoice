...
export function App() {
  ...
  const [voicePicker, setVoicePicker] = useState<'voice' | 'emotion' | null>(null);
  ...
  function selectVoice(voice: Voice) { change(voicePicker === 'emotion' ? { emotionVoiceId: voice.id } : { voiceId: voice.id }); setVoicePicker(null); }
